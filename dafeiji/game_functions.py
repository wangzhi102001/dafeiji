...
def check_event(ai_setting, sb, screen, stats, play_button, ship, aliens, bullets):
    # 响应鼠标和键盘事件
...
def start_game(ai_setting, aliens, bullets, sb, screen, ship, stats):
...
def check_play_button(ai_setting, sb, screen, stats, play_button, ship, aliens, bullets, mouse_x, mouse_y):
...
def check_key_down_events(event, ai_setting, stats, aliens, sb, screen, ship, bullets):
    # 响应“按下按键”事件
    if event.key == pygame.K_RIGHT:
...
def check_bullet_alien_collisons(ai_setting, aliens, bullets, screen, stats, sb, ship):
    """响应子弹和外星人的碰撞"""
    # 删除发生碰撞的子弹和外星人
...
def update_bullets(ai_setting, screen, stats, sb, ship, aliens, bullets):
    ...
    check_bullet_alien_collisons(
        ai_setting, aliens, bullets, screen, stats, sb, ship)
